...
function Login() {
  ...
  return (
    <section id='login_screen' className='login_screen'>
      ...
      <Grid container component="main" sx={{ height: '100vh', }}>
        ...
        />
        <Grid item className='login_bgright' xs={12} sm={8} md={5} lg={4} component={Paper} 
          sx={{
            boxShadow: 'none',
          }}>
          <Box 
              ...
              <Typography sx={{fontWeight: 'bold', fontSize: "1.4rem",mb: "20px", display: 'flex', width: "100%", justifyContent: 'start', color: "#555", height: "2rem", alignItems: "center" }}>
                ...
                <Box component="form" onSubmit={handleSubmit} sx={{ mt: 1 }} className='login_form'>
                  ...
                  <Box sx={{width: "100%", display: 'flex', justifyContent: 'right', mt: '10px'}}>
                    <Link variant="body2" onClick={undefined}>
                          Forgot password?
                    </Link>
                  </Box>
